...
const Tabs = ({ activeTab, setActiveTab, classname }: Props) => {
  ...
  return (
    <div
      className={`my-[40px] flex w-screen flex-row border-b border-tea-green border-opacity-20 px-[27px] text-[20px] md:border-b-0 md:px-0 ${classname} md:justify-center`}
    >
      <div
      ...
      >
        <div
          className={`${
            activeTab === "CREATE" ? "text-white" : "text-white/40"
      ...
      >
        <div
          className={`text-[20px] md:text-[24px] ${
            activeTab === "HISTORY" ? "text-white" : "text-white/40"
          }`}
        >
          My Swaps
        </div>
