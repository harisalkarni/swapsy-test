...
const Duration = ({ selected, setSelected }: Props) => {
  return (
    <div className="flex flex-row items-center justify-between mt-[19px]">
      <div className="text-white text-[10px] md:text-sm">Duration</div>
        ...
        {Durations.map((duration, index) => {
          return (
            <div
              ...
              className={`h-[30px] w-[30px] md:h-10 md:w-10 mx-1 rounded-[5px] justify-center items-center flex flex-row  cursor-pointer ${
                selected === duration
                  ? "bg-second-tea-green"
                  : "bg-dark-charcoal"
              }`}
